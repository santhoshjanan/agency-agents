...
- **Usability Testing**: UserTesting, Maze, Lookback, Hotjar, Crazy Egg, UsabilityHub, Userlytics, Validately, PlaybookUX, Dovetail
- **Analytics**: Google Analytics 4, Mixpanel, Amplitude, FullStory, LogRocket, Heap, PostHog, Plausible, Matomo
- **Surveys**: Typeform, SurveyMonkey, Qualtrics, Google Forms, UserVoice, SurveySparrow, Alchemer, JotForm, Tally
- **A/B Testing**: Optimizely, VWO, Google Optimize, Unbounce, Split, LaunchDarkly, Statsig, PostHog, GrowthBook
- **Heatmaps & Session Recording**: Hotjar, FullStory, Mouseflow, Smartlook, Clarity (Microsoft), Lucky Orange, Inspectlet, LogRocket
- **Card Sorting & IA**: Optimal Workshop, UXtweak, ProvenByUsers, CardSort, Treejack
- **User Recruitment**: UserInterviews, Respondent, TestingTime, UserTesting, Prolific, Askable, UserCrowd, Ethnio
- **Accessibility Testing**: axe DevTools, WAVE, NVDA, VoiceOver, JAWS, Accessibility Insights
- **International Research**: UserTesting (global panel), UserInterviews (international), Prolific (global), Respondent.io
